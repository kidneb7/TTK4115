...
typedef struct {
  ...
  real_T Elev_offset;                  /* '<Root>/Elev_offset' */
  ...
  real_T Voltageoffset;                /* '<S6>/Voltage offset' */
  real_T K_ei;                         /* '<S7>/K_ei' */
...
struct P_P2p1_T_ {
  ...
  real_T Pitch_offset;                 /* Variable: Pitch_offset
                                        * Referenced by: '<S2>/Ptch_offset'
                                        */
  real_T Travel_offset;                /* Variable: Travel_offset
                                        * Referenced by: '<S2>/Trvl_offset'
                                        */
  ...
  real_T Gain4_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Elev_offset_Value;            /* Expression: 0.0
                                        * Referenced by: '<Root>/Elev_offset'
                                        */
  ...
  real_T Gain2_Gain;                   /* Expression: 180/pi
                                        ...
                                        */
  real_T Voltageoffset_Value;          /* Expression: 0
                                        * Referenced by: '<S6>/Voltage offset'
                                        */
 ...
 * '<Root>' : 'P2p1'
 * '<S1>'   : 'P2p1/Conversion'
 * '<S2>'   : 'P2p1/Coordinate Transform'
 * '<S3>'   : 'P2p1/Elevation controller'
 * '<S4>'   : 'P2p1/Heli 3D'
 * '<S5>'   : 'P2p1/Joystick'
 * '<S6>'   : 'P2p1/Pitch controller'
 * '<S7>'   : 'P2p1/Elevation controller/Elevation controller'
 * '<S8>'   : 'P2p1/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'P2p1/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'P2p1/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'P2p1/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'P2p1/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'P2p1/Heli 3D/Travel rate  rad to deg'
 */
