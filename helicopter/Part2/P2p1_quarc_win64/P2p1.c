 ...
 * C source code generated on : Fri Oct 19 16:26:17 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* Gain: '<S12>/Gain' */
    P2p1_B.Gain = P2p1_P.Gain_Gain * P2p1_B.TravelCounttorad;

    /* Sum: '<S2>/Add2' incorporates:
     *  Constant: '<S2>/Trvl_offset'
     */
    P2p1_B.Add2 = P2p1_B.Gain - P2p1_P.Travel_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
     ...
     */
    P2p1_B.Add3 = P2p1_B.Gain_i - P2p1_P.Pitch_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
     ...
     */
    P2p1_B.Add1 = P2p1_B.Gain_e - P2p1_P.Elevation_offset;
  }
  ...
  /* Gain: '<S2>/Gain4' */
  rtb_Gain4_idx_2 = P2p1_P.Gain4_Gain * P2p1_B.Add3;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Constant: '<Root>/Elev_offset' */
    P2p1_B.Elev_offset = P2p1_P.Elev_offset_Value;
  }

  /* Sum: '<S3>/Sum' incorporates:
   *  Gain: '<S2>/Gain4'
   */
  rtb_Sum_p = P2p1_B.Elev_offset - P2p1_P.Gain4_Gain * P2p1_B.Add1;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Constant: '<S3>/Constant' */
    P2p1_B.Constant = P2p1_P.V_s_meas;
  }
   ...
   *  Sum: '<S7>/Sum'
   */
  P2p1_B.Sum1 = ((P2p1_P.K_ep_Gain * rtb_Sum_p + rtb_Backgain) -
                 P2p1_P.Gain4_Gain * P2p1_B.Gain_dg * P2p1_P.K_ed_Gain) +
    P2p1_B.Constant;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* Gain: '<Root>/Gain' */
    P2p1_B.Gain_j = P2p1_P.Joystick_gain_x * P2p1_B.Joystick_gain_x;
  }

  /* Gain: '<Root>/Gain2' */
  P2p1_B.Gain2[0] = P2p1_P.Gain2_Gain * P2p1_B.Gain_j;
  P2p1_B.Gain2[1] = P2p1_P.Gain2_Gain * rtb_Gain4_idx_2;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Constant: '<S6>/Voltage offset' */
    P2p1_B.Voltageoffset = P2p1_P.Voltageoffset_Value;
  }
   ...
   *  Sum: '<S6>/Sum1'
   */
  rtb_Backgain = ((P2p1_B.Gain_j - rtb_Gain4_idx_2) * P2p1_P.K_pp -
                  P2p1_P.Gain4_Gain * P2p1_B.Gain_b * P2p1_P.K_pd) +
    P2p1_B.Voltageoffset;

  /* Sum: '<S1>/Add' */
  rtb_Gain4_idx_2 = rtb_Backgain + P2p1_B.Sum1;

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (P2p1_B.Sum1 - rtb_Backgain) * P2p1_P.Backgain_Gain;
  ...
  /* Gain: '<S1>/Front gain' */
  rtb_Gain4_idx_2 *= P2p1_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (rtb_Gain4_idx_2 > P2p1_P.FrontmotorSaturation_UpperSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Gain4_idx_2 < P2p1_P.FrontmotorSaturation_LowerSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p1_B.FrontmotorSaturation = rtb_Gain4_idx_2;
  }
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (2993667049U);
  P2p1_M->Sizes.checksums[1] = (1035675957U);
  P2p1_M->Sizes.checksums[2] = (3275722394U);
  P2p1_M->Sizes.checksums[3] = (2006541197U);
  ...
  P2p1_M->Sizes.numBlockIO = (27);     /* Number of block outputs */
  P2p1_M->Sizes.numBlockPrms = (157);  /* Sum of parameter "widths" */
  return P2p1_M;
}
