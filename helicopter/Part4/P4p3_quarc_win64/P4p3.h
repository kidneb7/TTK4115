 ...
 * C source code generated on : Fri Oct 19 17:43:29 2018
 *
...
typedef struct {
  ...
  real_T Add1;                         /* '<S3>/Add1' */
  real_T Gain_dg;                      /* '<S13>/Gain' */
  real_T raddeg[6];                    /* '<Root>/rad-deg' */
  real_T raddeg5[2];                   /* '<S8>/rad-deg5' */
  real_T raddeg6[2];                   /* '<S8>/rad-deg6' */
  real_T raddeg3[2];                   /* '<S8>/rad-deg3' */
  real_T raddeg4[2];                   /* '<S8>/rad-deg4' */
  real_T raddeg1[2];                   /* '<S8>/rad-deg1' */
  real_T raddeg2[2];                   /* '<S8>/rad-deg2' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevationrate_PWORK;               /* '<S8>/Elevation rate' */
  ...
  struct {
    void *LoggedData;
  } Travelrate_PWORK;                  /* '<S8>/Travel rate' */
...
struct P_P4p3_T_ {
  ...
  real_T B_est[12];                    /* Variable: B_est
                                        * Referenced by: '<S5>/B'
                                        */
  real_T C_est2[12];                   /* Variable: C_est2
                                        * Referenced by:
                                        *   '<S5>/C'
                                        *   '<S5>/C1'
                                        */
 ...
 * '<S1>'   : 'P4p3/Controller'
 * '<S2>'   : 'P4p3/Conversion'
 * '<S3>'   : 'P4p3/Coordinate Transform'
 * '<S4>'   : 'P4p3/Elapsed Time'
 * '<S5>'   : 'P4p3/Estimator'
 * '<S6>'   : 'P4p3/Heli 3D'
 * '<S7>'   : 'P4p3/Joystick'
 * '<S8>'   : 'P4p3/Scopeman'
 * '<S9>'   : 'P4p3/Estimator/Swap state positions'
 * '<S10>'  : 'P4p3/Estimator/Swap state positions back'
 * '<S11>'  : 'P4p3/Estimator/Vector integrator'
 * '<S12>'  : 'P4p3/Heli 3D/Elevation rad to deg'
 * '<S13>'  : 'P4p3/Heli 3D/Elevation rate rad to deg'
 * '<S14>'  : 'P4p3/Heli 3D/Pitch rad to deg'
 * '<S15>'  : 'P4p3/Heli 3D/Pitch rate rad to deg'
 * '<S16>'  : 'P4p3/Heli 3D/Travel rad to deg'
 * '<S17>'  : 'P4p3/Heli 3D/Travel rate  rad to deg'
 */
