...
void P4p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p3_B.Sum1[i] = (P4p3_P.L[i + 6] * rtb_Gain4_idx_0 + P4p3_P.L[i] *
...
RT_MODEL_P4p3_T *P4p3(void)
{
  ...
  /* External mode info */
  P4p3_M->Sizes.checksums[0] = (1223702010U);
  P4p3_M->Sizes.checksums[1] = (1739434121U);
  P4p3_M->Sizes.checksums[2] = (3671356344U);
  P4p3_M->Sizes.checksums[3] = (4228374912U);
