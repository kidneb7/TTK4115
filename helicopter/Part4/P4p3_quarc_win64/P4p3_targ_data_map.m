  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p3_P.DiscreteTimeIntegrator_gainval
	  section.data(34).logicalSrcIdx = 113;
	  section.data(34).dtTransOffset = 33;
	
	  ;% P4p3_P.DiscreteTimeIntegrator_IC
	  section.data(35).logicalSrcIdx = 114;
	  section.data(35).dtTransOffset = 34;
	
	  ;% P4p3_P.Switch_Threshold
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p3_DW.Elevation_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p3_DW.Elevationrate_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P4p3_DW.Pitch_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p3_DW.Pitchrate_PWORK.LoggedData
	  ...
	  ;% P4p3_DW.Travel_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% P4p3_DW.Travelrate_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% P4p3_DW.Scope_PWORK.LoggedData
	  ...
	  ;% P4p3_DW.DiscreteTimeIntegrator_PrevRese
  ...
  targMap.checksum0 = 1223702010;
  targMap.checksum1 = 1739434121;
  targMap.checksum2 = 3671356344;
  targMap.checksum3 = 4228374912;
