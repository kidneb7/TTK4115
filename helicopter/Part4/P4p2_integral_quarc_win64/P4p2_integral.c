...
void P4p2_integral_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     */
    P4p2_integral_B.Add2 = P4p2_integral_B.Gain - P4p2_integral_P.Travel_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     */
    P4p2_integral_B.Add3 = P4p2_integral_B.Gain_i - P4p2_integral_P.Pitch_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     */
    P4p2_integral_B.Add1 = P4p2_integral_B.Gain_e -
  ...
  /* Gain: '<S3>/Gain4' */
  rtb_Gain4_idx_0 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Add2;
  rtb_Gain4_idx_1 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Gain_d;
  rtb_Gain4_idx_2 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Add3;
  rtb_Gain4_idx_3 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Gain_b;
  rtb_Gain4_idx_4 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Add1;
  rtb_Gain4_idx_5 = P4p2_integral_P.Gain4_Gain * P4p2_integral_B.Gain_dg;

  /* Integrator: '<S10>/Integrator5' */
  P4p2_integral_B.Integrator5 = P4p2_integral_X.Integrator5_CSTATE;

  /* Integrator: '<S10>/Integrator3' */
  P4p2_integral_B.Integrator3 = P4p2_integral_X.Integrator3_CSTATE;

  /* Gain: '<Root>/rad-deg' incorporates:
   *  Integrator: '<S10>/Integrator1'
   */
  P4p2_integral_B.raddeg[0] = P4p2_integral_P.raddeg_Gain * rtb_Gain4_idx_0;
  P4p2_integral_B.raddeg[1] = P4p2_integral_P.raddeg_Gain * rtb_Gain4_idx_2;
  P4p2_integral_B.raddeg[2] = P4p2_integral_P.raddeg_Gain * rtb_Gain4_idx_4;
  P4p2_integral_B.raddeg[3] = P4p2_integral_P.raddeg_Gain *
    P4p2_integral_B.Integrator5;
  P4p2_integral_B.raddeg[4] = P4p2_integral_P.raddeg_Gain *
    P4p2_integral_X.Integrator1_CSTATE;
  P4p2_integral_B.raddeg[5] = P4p2_integral_P.raddeg_Gain *
    P4p2_integral_B.Integrator3;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Integrator: '<S10>/Integrator6' */
  P4p2_integral_B.Integrator6 = P4p2_integral_X.Integrator6_CSTATE;

  /* Sum: '<Root>/Sum' incorporates:
   *  Integrator: '<S10>/Integrator1'
   *  Integrator: '<S10>/Integrator2'
   *  Integrator: '<S10>/Integrator4'
   */
  P4p2_integral_B.Sum[0] = rtb_Gain4_idx_0 - P4p2_integral_B.Integrator5;
  P4p2_integral_B.Sum[1] = rtb_Gain4_idx_1 - P4p2_integral_B.Integrator6;
  P4p2_integral_B.Sum[2] = rtb_Gain4_idx_2 - P4p2_integral_X.Integrator1_CSTATE;
  P4p2_integral_B.Sum[3] = rtb_Gain4_idx_3 - P4p2_integral_X.Integrator2_CSTATE;
  P4p2_integral_B.Sum[4] = rtb_Gain4_idx_4 - P4p2_integral_B.Integrator3;
  P4p2_integral_B.Sum[5] = rtb_Gain4_idx_5 - P4p2_integral_X.Integrator4_CSTATE;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg5' */
  P4p2_integral_B.raddeg5[0] = P4p2_integral_P.raddeg5_Gain * rtb_Gain4_idx_4;
  P4p2_integral_B.raddeg5[1] = P4p2_integral_P.raddeg5_Gain *
    P4p2_integral_B.Integrator3;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg6' incorporates:
   *  Integrator: '<S10>/Integrator4'
   */
  P4p2_integral_B.raddeg6[0] = P4p2_integral_P.raddeg6_Gain * rtb_Gain4_idx_5;
  P4p2_integral_B.raddeg6[1] = P4p2_integral_P.raddeg6_Gain *
    P4p2_integral_X.Integrator4_CSTATE;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg3' incorporates:
   *  Integrator: '<S10>/Integrator1'
   */
  P4p2_integral_B.raddeg3[0] = P4p2_integral_P.raddeg3_Gain * rtb_Gain4_idx_2;
  P4p2_integral_B.raddeg3[1] = P4p2_integral_P.raddeg3_Gain *
    P4p2_integral_X.Integrator1_CSTATE;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg4' incorporates:
   *  Integrator: '<S10>/Integrator2'
   */
  P4p2_integral_B.raddeg4[0] = P4p2_integral_P.raddeg4_Gain * rtb_Gain4_idx_3;
  P4p2_integral_B.raddeg4[1] = P4p2_integral_P.raddeg4_Gain *
    P4p2_integral_X.Integrator2_CSTATE;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg1' */
  P4p2_integral_B.raddeg1[0] = P4p2_integral_P.raddeg1_Gain * rtb_Gain4_idx_0;
  P4p2_integral_B.raddeg1[1] = P4p2_integral_P.raddeg1_Gain *
    P4p2_integral_B.Integrator5;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }

  /* Gain: '<S7>/rad-deg2' */
  P4p2_integral_B.raddeg2[0] = P4p2_integral_P.raddeg2_Gain * rtb_Gain4_idx_1;
  P4p2_integral_B.raddeg2[1] = P4p2_integral_P.raddeg2_Gain *
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    /* Gain: '<Root>/Gain' */
    P4p2_integral_B.Gain_j = P4p2_integral_P.Joystick_gain_x *
    ...
    /* Gain: '<Root>/Gain1' */
    P4p2_integral_B.Gain1 = P4p2_integral_P.Joystick_gain_y *
    ...
    P4p2_integral_B.P[0] += P4p2_integral_P.P_i[0] * P4p2_integral_B.Gain_j;
    P4p2_integral_B.P[0] += P4p2_integral_P.P_i[2] * P4p2_integral_B.Gain1;
    P4p2_integral_B.P[1] = 0.0;
    P4p2_integral_B.P[1] += P4p2_integral_P.P_i[1] * P4p2_integral_B.Gain_j;
    P4p2_integral_B.P[1] += P4p2_integral_P.P_i[3] * P4p2_integral_B.Gain1;
  }
   ...
   */
  tmp[0] = P4p2_integral_X.Integrator1_CSTATE;
  tmp[1] = P4p2_integral_X.Integrator2_CSTATE;
  tmp[2] = P4p2_integral_X.Integrator4_CSTATE;
  tmp[3] = P4p2_integral_X.Integrator_CSTATE;
  tmp[4] = P4p2_integral_X.Integrator1_CSTATE_l;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Integrator1 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Integrator1 += P4p2_integral_P.K_[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_TmpSignalConversionAtBInpor[i] = P4p2_integral_B.P[i] - rtb_Integrator1;
  }

  /* End of Sum: '<S1>/Sum' */
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* Constant: '<S1>/V_meas' */
    P4p2_integral_B.V_meas = P4p2_integral_P.V_s_meas;
  }

  /* Sum: '<S1>/Sum1' */
  rtb_Integrator1 = rtb_TmpSignalConversionAtBInpor[0] + P4p2_integral_B.V_meas;

  /* Sum: '<S1>/Sum2' incorporates:
   *  Integrator: '<S10>/Integrator1'
   */
  P4p2_integral_B.Sum2 = P4p2_integral_X.Integrator1_CSTATE -
    P4p2_integral_B.Gain_j;

  /* Sum: '<S1>/Sum3' incorporates:
   *  Integrator: '<S10>/Integrator4'
   */
  P4p2_integral_B.Sum3 = P4p2_integral_X.Integrator4_CSTATE -
   ...
   *  Integrator: '<S10>/Integrator4'
   */
  rtb_TmpSignalConversionAtAInpor[0] = P4p2_integral_X.Integrator1_CSTATE;
  rtb_TmpSignalConversionAtAInpor[1] = P4p2_integral_X.Integrator2_CSTATE;
  rtb_TmpSignalConversionAtAInpor[2] = P4p2_integral_B.Integrator3;
  rtb_TmpSignalConversionAtAInpor[3] = P4p2_integral_X.Integrator4_CSTATE;
  rtb_TmpSignalConversionAtAInpor[4] = P4p2_integral_B.Integrator5;
  rtb_TmpSignalConversionAtAInpor[5] = P4p2_integral_B.Integrator6;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* Constant: '<S4>/Constant' */
    P4p2_integral_B.Constant = P4p2_integral_P.V_s_meas;
  }

  /* Sum: '<S4>/Sum3' */
  rtb_Integrator1 -= P4p2_integral_B.Constant;
  for (i = 0; i < 6; i++) {
     ...
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += P4p2_integral_P.B_est[i] * rtb_Integrator1;
    tmp_0[i] += P4p2_integral_P.B_est[i + 6] * rtb_TmpSignalConversionAtBInpor[1];
    ...
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_1[i] += P4p2_integral_P.A_est[6 * i_0 + i] *
  ...
  for (i = 0; i < 3; i++) {
    tmp_2[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_2[i] += P4p2_integral_P.C_est[3 * i_0 + i] * rtb_Gain4_0[i_0];
    }
  }
  ...
  for (i = 0; i < 3; i++) {
    tmp_3[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_3[i] += P4p2_integral_P.C_est[3 * i_0 + i] *
        rtb_TmpSignalConversionAtAInpor[i_0];
    }
  }
   ...
   *  Gain: '<S4>/L'
   */
  rtb_Integrator1 = tmp_2[0] - tmp_3[0];
  rtb_Gain4_idx_0 = tmp_2[1] - tmp_3[1];
  rtb_Gain4_idx_1 = tmp_2[2] - tmp_3[2];
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p2_integral_B.Sum1[i] = ((P4p2_integral_P.L[i + 6] * rtb_Gain4_idx_0 +
      P4p2_integral_P.L[i] * rtb_Integrator1) + P4p2_integral_P.L[i + 12] *
      rtb_Gain4_idx_1) + (tmp_0[i] + tmp_1[i]);
  }
  ...
  /* Gain: '<S2>/Front gain' */
  rtb_Integrator1 = P4p2_integral_P.Frontgain_Gain * rtb_Add;

  /* Saturate: '<S5>/Front motor: Saturation' */
  if (rtb_Integrator1 > P4p2_integral_P.FrontmotorSaturation_UpperSat) {
    P4p2_integral_B.FrontmotorSaturation =
      P4p2_integral_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Integrator1 < P4p2_integral_P.FrontmotorSaturation_LowerSat) {
    P4p2_integral_B.FrontmotorSaturation =
      P4p2_integral_P.FrontmotorSaturation_LowerSat;
  } else {
    P4p2_integral_B.FrontmotorSaturation = rtb_Integrator1;
  }

  /* End of Saturate: '<S5>/Front motor: Saturation' */

  /* Gain: '<S2>/Back gain' */
  rtb_Integrator1 = P4p2_integral_P.Backgain_Gain * rtb_Subtract;

  /* Saturate: '<S5>/Back motor: Saturation' */
  if (rtb_Integrator1 > P4p2_integral_P.BackmotorSaturation_UpperSat) {
    P4p2_integral_B.BackmotorSaturation =
      P4p2_integral_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Integrator1 < P4p2_integral_P.BackmotorSaturation_LowerSat) {
    P4p2_integral_B.BackmotorSaturation =
      P4p2_integral_P.BackmotorSaturation_LowerSat;
  } else {
    P4p2_integral_B.BackmotorSaturation = rtb_Integrator1;
  }
...
void P4p2_integral_derivatives(void)
{
  ...
  /* Derivatives for Integrator: '<S10>/Integrator5' */
  _rtXdot->Integrator5_CSTATE = P4p2_integral_B.Sum1[4];

  /* Derivatives for Integrator: '<S10>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = P4p2_integral_B.Sum1[0];

  /* Derivatives for Integrator: '<S10>/Integrator3' */
  _rtXdot->Integrator3_CSTATE = P4p2_integral_B.Sum1[2];

  /* Derivatives for Integrator: '<S10>/Integrator6' */
  _rtXdot->Integrator6_CSTATE = P4p2_integral_B.Sum1[5];

  /* Derivatives for Integrator: '<S10>/Integrator2' */
  _rtXdot->Integrator2_CSTATE = P4p2_integral_B.Sum1[1];

  /* Derivatives for Integrator: '<S10>/Integrator4' */
  _rtXdot->Integrator4_CSTATE = P4p2_integral_B.Sum1[3];

  /* Derivatives for Integrator: '<S1>/Integrator' */
  _rtXdot->Integrator_CSTATE = P4p2_integral_B.Sum2;

  /* Derivatives for Integrator: '<S1>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_l = P4p2_integral_B.Sum3;
}
...
void P4p2_integral_initialize(void)
{
  ...
  /* InitializeConditions for Integrator: '<S10>/Integrator5' */
  P4p2_integral_X.Integrator5_CSTATE = P4p2_integral_P.Integrator5_IC;

  /* InitializeConditions for Integrator: '<S10>/Integrator1' */
  P4p2_integral_X.Integrator1_CSTATE = P4p2_integral_P.Integrator1_IC;

  /* InitializeConditions for Integrator: '<S10>/Integrator3' */
  P4p2_integral_X.Integrator3_CSTATE = P4p2_integral_P.Integrator3_IC;

  /* InitializeConditions for Integrator: '<S10>/Integrator6' */
  P4p2_integral_X.Integrator6_CSTATE = P4p2_integral_P.Integrator6_IC;

  /* InitializeConditions for Integrator: '<S10>/Integrator2' */
  P4p2_integral_X.Integrator2_CSTATE = P4p2_integral_P.Integrator2_IC;

  /* InitializeConditions for Integrator: '<S10>/Integrator4' */
  P4p2_integral_X.Integrator4_CSTATE = P4p2_integral_P.Integrator4_IC;

  /* InitializeConditions for Integrator: '<S1>/Integrator' */
  P4p2_integral_X.Integrator_CSTATE = P4p2_integral_P.Integrator_IC;

  /* InitializeConditions for Integrator: '<S1>/Integrator1' */
  P4p2_integral_X.Integrator1_CSTATE_l = P4p2_integral_P.Integrator1_IC_m;

  /* InitializeConditions for RateTransition: '<S6>/Rate Transition: x' */
  P4p2_integral_DW.RateTransitionx_Buffer0 = P4p2_integral_P.RateTransitionx_X0;

  /* InitializeConditions for RateTransition: '<S6>/Rate Transition: y' */
  P4p2_integral_DW.RateTransitiony_Buffer0 = P4p2_integral_P.RateTransitiony_X0;
}
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
  ...
  /* External mode info */
  P4p2_integral_M->Sizes.checksums[0] = (1628656500U);
  P4p2_integral_M->Sizes.checksums[1] = (1134373048U);
  P4p2_integral_M->Sizes.checksums[2] = (2270857550U);
  P4p2_integral_M->Sizes.checksums[3] = (919082566U);
...

  {
    ...
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Sum1[i] = 0.0;
    }

    P4p2_integral_B.TravelCounttorad = 0.0;
    P4p2_integral_B.Gain = 0.0;
    P4p2_integral_B.Add2 = 0.0;
    P4p2_integral_B.Gain_d = 0.0;
    P4p2_integral_B.PitchCounttorad = 0.0;
    P4p2_integral_B.Gain_i = 0.0;
    P4p2_integral_B.Add3 = 0.0;
    P4p2_integral_B.Gain_b = 0.0;
    P4p2_integral_B.ElevationCounttorad = 0.0;
    P4p2_integral_B.Gain_e = 0.0;
    P4p2_integral_B.Add1 = 0.0;
    P4p2_integral_B.Gain_dg = 0.0;
    P4p2_integral_B.Integrator5 = 0.0;
    P4p2_integral_B.Integrator3 = 0.0;
    P4p2_integral_B.Integrator6 = 0.0;
    P4p2_integral_B.raddeg5[0] = 0.0;
    P4p2_integral_B.raddeg5[1] = 0.0;
    P4p2_integral_B.raddeg6[0] = 0.0;
    P4p2_integral_B.raddeg6[1] = 0.0;
    P4p2_integral_B.raddeg3[0] = 0.0;
    P4p2_integral_B.raddeg3[1] = 0.0;
    P4p2_integral_B.raddeg4[0] = 0.0;
    P4p2_integral_B.raddeg4[1] = 0.0;
    P4p2_integral_B.raddeg1[0] = 0.0;
    P4p2_integral_B.raddeg1[1] = 0.0;
    P4p2_integral_B.raddeg2[0] = 0.0;
    P4p2_integral_B.raddeg2[1] = 0.0;
    P4p2_integral_B.RateTransitionx = 0.0;
    P4p2_integral_B.Joystick_gain_x = 0.0;
    P4p2_integral_B.Gain_j = 0.0;
    P4p2_integral_B.RateTransitiony = 0.0;
    P4p2_integral_B.Joystick_gain_y = 0.0;
    P4p2_integral_B.Gain1 = 0.0;
    P4p2_integral_B.P[0] = 0.0;
    P4p2_integral_B.P[1] = 0.0;
    P4p2_integral_B.V_meas = 0.0;
    P4p2_integral_B.Sum2 = 0.0;
    P4p2_integral_B.Sum3 = 0.0;
    P4p2_integral_B.Constant = 0.0;
  ...
  P4p2_integral_M->Sizes.numBlocks = (102);/* Number of blocks */
  P4p2_integral_M->Sizes.numBlockIO = (39);/* Number of block outputs */
  P4p2_integral_M->Sizes.numBlockPrms = (259);/* Sum of parameter "widths" */
