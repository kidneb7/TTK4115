...
typedef struct {
  ...
  real_T Integrator5;                  /* '<S10>/Integrator5' */
  real_T Integrator3;                  /* '<S10>/Integrator3' */
  real_T raddeg[6];                    /* '<Root>/rad-deg' */
  real_T Integrator6;                  /* '<S10>/Integrator6' */
  real_T Sum[6];                       /* '<Root>/Sum' */
  real_T raddeg5[2];                   /* '<S7>/rad-deg5' */
  real_T raddeg6[2];                   /* '<S7>/rad-deg6' */
  real_T raddeg3[2];                   /* '<S7>/rad-deg3' */
  real_T raddeg4[2];                   /* '<S7>/rad-deg4' */
  real_T raddeg1[2];                   /* '<S7>/rad-deg1' */
  real_T raddeg2[2];                   /* '<S7>/rad-deg2' */
  ...
  real_T P[2];                         /* '<S1>/P' */
  real_T V_meas;                       /* '<S1>/V_meas' */
  real_T Sum2;                         /* '<S1>/Sum2' */
  real_T Sum3;                         /* '<S1>/Sum3' */
  real_T Constant;                     /* '<S4>/Constant' */
  real_T Sum1[6];                      /* '<S4>/Sum1' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevationrate_PWORK;               /* '<S7>/Elevation rate' */
  ...
  struct {
    void *LoggedData;
  } ToWorkspace3_PWORK_j;              /* '<S7>/To Workspace3' */
  ...
  struct {
    void *LoggedData;
  } Travelrate_PWORK;                  /* '<S7>/Travel rate' */
...
typedef struct {
  ...
  real_T Integrator5_CSTATE;           /* '<S10>/Integrator5' */
  real_T Integrator1_CSTATE;           /* '<S10>/Integrator1' */
  real_T Integrator3_CSTATE;           /* '<S10>/Integrator3' */
  real_T Integrator6_CSTATE;           /* '<S10>/Integrator6' */
  real_T Integrator2_CSTATE;           /* '<S10>/Integrator2' */
  real_T Integrator4_CSTATE;           /* '<S10>/Integrator4' */
  real_T Integrator_CSTATE;            /* '<S1>/Integrator' */
  real_T Integrator1_CSTATE_l;         /* '<S1>/Integrator1' */
} X_P4p2_integral_T;
...
typedef struct {
  ...
  boolean_T Integrator5_CSTATE;        /* '<S10>/Integrator5' */
  boolean_T Integrator1_CSTATE;        /* '<S10>/Integrator1' */
  boolean_T Integrator3_CSTATE;        /* '<S10>/Integrator3' */
  boolean_T Integrator6_CSTATE;        /* '<S10>/Integrator6' */
  boolean_T Integrator2_CSTATE;        /* '<S10>/Integrator2' */
  boolean_T Integrator4_CSTATE;        /* '<S10>/Integrator4' */
  boolean_T Integrator_CSTATE;         /* '<S1>/Integrator' */
  boolean_T Integrator1_CSTATE_l;      /* '<S1>/Integrator1' */
...
struct P_P4p2_integral_T_ {
  real_T A_est[36];                    /* Variable: A_est
                                        * Referenced by: '<S4>/A'
                                        */
  real_T B_est[12];                    /* Variable: B_est
                                        * Referenced by: '<S4>/B'
                                        */
  real_T C_est[18];                    /* Variable: C_est
                                        * Referenced by:
                                        *   '<S4>/C'
                                        *   '<S4>/C1'
                                        */
  real_T Elevation_offset;             /* Variable: Elevation_offset
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        *   '<S6>/Joystick_gain_y'
                                        */
  real_T K_[10];                       /* Variable: K_
                                        * Referenced by: '<S1>/K'
                                        */
  real_T L[18];                        /* Variable: L
                                        * Referenced by: '<S4>/L'
                                        */
  real_T P_i[4];                       /* Variable: P_i
                                        * Referenced by: '<S1>/P'
                                        */
  real_T Pitch_offset;                 /* Variable: Pitch_offset
                                        * Referenced by: '<S3>/Ptch_offset'
                                        */
  real_T Travel_offset;                /* Variable: Travel_offset
                                        * Referenced by: '<S3>/Trvl_offset'
                                        */
  real_T V_s_meas;                     /* Variable: V_s_meas
                                        * Referenced by:
                                        *   '<S1>/V_meas'
                                        *   '<S4>/Constant'
                                        */
 ...
 *
 * '<Root>' : 'P4p2_integral'
 * '<S1>'   : 'P4p2_integral/Controller'
 * '<S2>'   : 'P4p2_integral/Conversion'
 * '<S3>'   : 'P4p2_integral/Coordinate Transform'
 * '<S4>'   : 'P4p2_integral/Estimator'
 * '<S5>'   : 'P4p2_integral/Heli 3D'
 * '<S6>'   : 'P4p2_integral/Joystick'
 * '<S7>'   : 'P4p2_integral/scope'
 * '<S8>'   : 'P4p2_integral/Estimator/Swap state positions'
 * '<S9>'   : 'P4p2_integral/Estimator/Swap state positions back'
 * '<S10>'  : 'P4p2_integral/Estimator/Vector integrator'
 * '<S11>'  : 'P4p2_integral/Heli 3D/Elevation rad to deg'
 * '<S12>'  : 'P4p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S13>'  : 'P4p2_integral/Heli 3D/Pitch rad to deg'
 * '<S14>'  : 'P4p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S15>'  : 'P4p2_integral/Heli 3D/Travel rad to deg'
 * '<S16>'  : 'P4p2_integral/Heli 3D/Travel rate  rad to deg'
 */
