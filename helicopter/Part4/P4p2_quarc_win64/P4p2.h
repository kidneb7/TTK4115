 ...
 *
 * '<Root>' : 'P4p2'
 * '<S1>'   : 'P4p2/Controller no integration'
 * '<S2>'   : 'P4p2/Conversion'
 * '<S3>'   : 'P4p2/Coordinate Transform'
 * '<S4>'   : 'P4p2/Estimator'
 * '<S5>'   : 'P4p2/Heli 3D'
 * '<S6>'   : 'P4p2/Joystick'
 * '<S7>'   : 'P4p2/Estimator/Swap state positions'
 * '<S8>'   : 'P4p2/Estimator/Swap state positions back'
 * '<S9>'   : 'P4p2/Estimator/Vector integrator'
 * '<S10>'  : 'P4p2/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'P4p2/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'P4p2/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'P4p2/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'P4p2/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'P4p2/Heli 3D/Travel rate  rad to deg'
 */
