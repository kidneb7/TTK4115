 ...
 * C source code generated on : Fri Oct 19 17:48:49 2018
 *
...
void P3p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
     ...
     */
    P3p3_B.Add2 = P3p3_B.Gain - P3p3_P.Travel_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
     ...
     */
    P3p3_B.Add3 = P3p3_B.Gain_i - P3p3_P.Pitch_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
     ...
     */
    P3p3_B.Add1 = P3p3_B.Gain_e - P3p3_P.Elevation_offset;
  }
  ...
  /* Gain: '<S2>/Gain4' */
  rtb_Gain4_idx_2 = P3p3_P.Gain4_Gain * P3p3_B.Add3;
  rtb_Gain4_idx_5 = P3p3_P.Gain4_Gain * P3p3_B.Gain_dg;
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* Gain: '<Root>/Gain' */
    P3p3_B.Gain_j = P3p3_P.Joystick_gain_x * P3p3_B.Joystick_gain_x;
  }

  /* End of RateTransition: '<S4>/Rate Transition: x' */

  /* Gain: '<Root>/Gain2' */
  P3p3_B.Gain2[0] = P3p3_P.Gain2_Gain * rtb_Gain4_idx_2;
  P3p3_B.Gain2[1] = P3p3_P.Gain2_Gain * P3p3_B.Gain_j;
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    P3p3_B.Gain1 = P3p3_P.Joystick_gain_y * P3p3_B.Joystick_gain_y;

    /* Gain: '<S5>/P' incorporates:
     *  SignalConversion: '<S5>/TmpSignal ConversionAtPInport1'
     */
    P3p3_B.P[0] = 0.0;
    P3p3_B.P[0] += P3p3_P.P_i[0] * P3p3_B.Gain_j;
    P3p3_B.P[0] += P3p3_P.P_i[2] * P3p3_B.Gain1;
    P3p3_B.P[1] = 0.0;
    P3p3_B.P[1] += P3p3_P.P_i[1] * P3p3_B.Gain_j;
    P3p3_B.P[1] += P3p3_P.P_i[3] * P3p3_B.Gain1;
  }
  ...
  rtb_Gain4_0[1] = P3p3_P.Gain4_Gain * P3p3_B.Gain_b;
  rtb_Gain4_0[2] = rtb_Gain4_idx_5;
  rtb_Gain4_0[3] = P3p3_X.Integrator_CSTATE;
  rtb_Gain4_0[4] = P3p3_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Frontgain = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Frontgain += P3p3_P.K_[(i_0 << 1) + i] * rtb_Gain4_0[i_0];
    }

    rtb_Sum[i] = P3p3_B.P[i] - rtb_Frontgain;
  }

  /* End of Sum: '<S5>/Sum' */
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* Constant: '<S5>/V_meas' */
    P3p3_B.V_meas = P3p3_P.V_s_meas;
  }

  /* Sum: '<S5>/Sum1' */
  rtb_Frontgain = rtb_Sum[0] + P3p3_B.V_meas;
  if (rtmIsMajorTimeStep(P3p3_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Sum[1] + rtb_Frontgain) * P3p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Frontgain - rtb_Sum[1]) * P3p3_P.Backgain_Gain;
  ...
  /* Sum: '<S5>/Sum2' */
  P3p3_B.Sum2 = rtb_Gain4_idx_2 - P3p3_B.Gain_j;

  /* Sum: '<S5>/Sum3' */
  P3p3_B.Sum3 = rtb_Gain4_idx_5 - P3p3_B.Gain1;
}
...
void P3p3_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = P3p3_B.Sum3;
}
...
RT_MODEL_P3p3_T *P3p3(void)
{
  ...
  /* External mode info */
  P3p3_M->Sizes.checksums[0] = (1897731482U);
  P3p3_M->Sizes.checksums[1] = (1520115051U);
  P3p3_M->Sizes.checksums[2] = (4157712573U);
  P3p3_M->Sizes.checksums[3] = (3058520922U);
  ...
  P3p3_M->Sizes.numBlocks = (61);      /* Number of blocks */
  P3p3_M->Sizes.numBlockIO = (27);     /* Number of block outputs */
