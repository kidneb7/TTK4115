 ...
 * '<Root>' : 'P3p3'
 * '<S1>'   : 'P3p3/Conversion'
 * '<S2>'   : 'P3p3/Coordinate Transform'
 * '<S3>'   : 'P3p3/Heli 3D'
 * '<S4>'   : 'P3p3/Joystick'
 * '<S5>'   : 'P3p3/LQR'
 * '<S6>'   : 'P3p3/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P3p3/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P3p3/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P3p3/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P3p3/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P3p3/Heli 3D/Travel rate  rad to deg'
 */
